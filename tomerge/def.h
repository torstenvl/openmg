...
#include	"chrdef.h"
#include	<term.h>      // IMPORTANT TO MERGE
#include	"netbsd.h"    // IMPORTANT TO MERGE
#include	"macos.h"     // IMPORTANT TO MERGE
 ...
 */
// #define STANDOUT_GLITCH			/* possible standout glitch - IMPORTANT TO MERGE */
